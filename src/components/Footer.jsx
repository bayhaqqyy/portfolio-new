...
const Footer = () => {
  return (
    <footer className="bg-slate-950 w-full py-12 border-t border-slate-800">
      <div className="flex flex-col md:flex-row justify-between items-center px-4 sm:px-8 max-w-7xl mx-auto text-center md:text-left">
        <div className="mb-6 md:mb-0">
          <div className="text-lg font-bold text-slate-200 font-headline mb-1">RAFLI ABDUL BAY HAQQY</div>
        ...
        <div className="text-slate-500 font-label text-xs">
          © 2026 System Engineer. All rights reserved.
        </div>
      </div>
    </footer>
  );
