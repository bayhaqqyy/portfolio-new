  ...
  return (
    <section className="py-24 px-8 max-w-7xl mx-auto" id="about">
      <div className="grid md:grid-cols-2 gap-12 items-center">
        <div className="bg-surface-container/60 backdrop-blur-xl p-8 rounded-3xl border border-outline-variant/15 shadow-2xl">
        ...
        <div className="bg-slate-950 rounded-2xl overflow-hidden border border-outline-variant/30 shadow-2xl font-label text-sm">
