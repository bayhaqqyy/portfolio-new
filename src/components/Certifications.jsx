      ...
      <motion.div layout className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <AnimatePresence mode="popLayout">
          {filteredCerts.map((cert) => (
            ...
            >
              <div className="h-40 mb-6 bg-slate-900 rounded-2xl flex items-center justify-center overflow-hidden relative">
                <img alt={cert.title} className="w-full h-full object-cover filter grayscale group-hover:grayscale-0 transition-all duration-500" src={cert.imgSrc} />
