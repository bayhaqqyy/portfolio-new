    ...
    <section className="py-24 px-8 max-w-7xl mx-auto" id="certs">
      ...
      <motion.div layout className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <AnimatePresence mode="popLayout">
          {/* Cert Card 1 */}
          {(activeFilter === 'All' || activeFilter === 'Linux') && (
            <motion.div 
              layout
              ...
              className="bg-surface-container p-6 rounded-3xl border border-outline-variant/20 hover:border-primary/50 transition-all group"
            >
          ...
          {(activeFilter === 'All' || activeFilter === 'Cloud') && (
            <motion.div 
              ...
              exit={{ scale: 0.8, opacity: 0 }}
              transition={{ duration: 0.3 }}
              className="bg-surface-container p-6 rounded-3xl border border-outline-variant/20 hover:border-secondary/50 transition-all group"
            >
              <div className="h-32 mb-6 bg-slate-900 rounded-2xl flex items-center justify-center p-6 overflow-hidden relative">
          ...
          {(activeFilter === 'All' || activeFilter === 'Network') && (
            <motion.div 
              ...
              exit={{ scale: 0.8, opacity: 0 }}
              transition={{ duration: 0.3 }}
              className="bg-surface-container p-6 rounded-3xl border border-outline-variant/20 hover:border-cyan-400/50 transition-all group"
            >
              <div className="h-32 mb-6 bg-slate-900 rounded-2xl flex items-center justify-center p-6 overflow-hidden relative">
