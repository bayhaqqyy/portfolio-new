  ...
  return (
    <section className="py-24 px-8 max-w-7xl mx-auto bg-surface-container-low/30" id="skills">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 md:grid-rows-2 gap-4 h-full">
        {/* Main Skill Card */}
        <div className="md:col-span-2 md:row-span-2 bg-gradient-to-br from-surface-container-highest to-surface p-8 rounded-3xl border border-primary/20 flex flex-col justify-between relative overflow-hidden group">
