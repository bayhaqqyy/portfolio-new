      ...
      <div className="grid md:grid-cols-2 gap-16">
        ...
        >
          ...
          <div className="space-y-6">
            <a href="mailto:hi@rafli.dev" className="flex items-center gap-4 group cursor-pointer block">
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
          className="bg-surface-container/40 backdrop-blur-xl p-8 rounded-3xl border border-outline-variant/20 shadow-2xl"
        >
          <form action="mailto:hi@rafli.dev" method="post" encType="text/plain" className="space-y-6">
